	...
	<body onload= "fecha(); reloj()">
		<div id="cuerpo">
			...
			<div id="contenido">
				...
				<?php 
				$nro = $_GET['nro'];
				$empresas->MostrarRegistro($nro); 
				?>
				<p align="center">
					<a class="button" href="../vistas/L_empresas.php"><img id= "volver" src="../images/iconos/ico_volver.png" alt="volver"/> Volver</a>
					<a class="button" href="../control/empresas.php?eliminar=si&nro=<?php echo $nro;?>"> <img id = "eliminar" src='../images/iconos/ico_eliminar.png' alt='Eliminar' /> Eliminar</a>
				</p>
